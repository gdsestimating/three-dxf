...
import { IVertex } from 'dxf-parser/dist/entities/lwpolyline.js';
import { IVertexEntity, IEntity, IDxf } from 'dxf-parser';

export function getColor(entity:IEntity, dxf:IDxf) {
    let color;
    if (entity.color) {
 ...
 */
export const angle2 = (p1: THREE.Vec2, p2: THREE.Vec2) => {
  ...
  export const polar = (point: THREE.Vec2, distance: number, angle: number) => {
